...
Generated credentials (database passwords, Grafana admin password) are stored in `/opt/ansible/secrets/` with `0600` permissions. Retrieve the Grafana admin password:
